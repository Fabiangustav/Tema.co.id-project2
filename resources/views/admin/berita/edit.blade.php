        ...
        <form action="{{ route('admin.berita.update', $berita->id) }}"
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <i class="fas fa-link"></i> Slug URL <span class="text-danger">*</span>
                        </label>
                        <div class="input-group">
                        ...
                        <small class="text-muted d-block mt-1">
                            Slug akan digunakan sebagai URL berita
                        </small>
                        @error('slug')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <i class="fas fa-toggle-on"></i> Status Publikasi <span class="text-danger">*</span>
                        </label>
                        <select name="status"
                ...
                <div class="col-md-6">
                    <!-- Gambar -->
                    <div class="form-group">
                        <label class="form-label"><i class="fas fa-image"></i> Gambar Utama</label>
            ...
            <div class="form-group mt-4">
                <label class="form-label"><i class="fas fa-align-left"></i> Konten Berita <span class="text-danger">*</span></label>
